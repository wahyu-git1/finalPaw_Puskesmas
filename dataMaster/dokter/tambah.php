...
<?php include "../componen/navigasi.php";?>
    ...
    <form action="" method="post">
        <label class="form-label" for="kodedokter">Kode Dokter</label>
        <input class="form-control" type="text" id="kodedokter" name="kodedokter" placeholder="Masukkan kode anda disini!" required><br>
        
        <label class="form-label" for="namadokter">Nama Dokter</label>
        <input class="form-control" type="text" id="namadokter" name="namadokter" placeholder="Masukkan nama anda disini!" required><br>
        
        <label class="form-label" for="spesialis">Spesialis</label>
        <input class="form-control" type="text" id="spesialis" name="spesialis" placeholder="Masukkan spesialisasi anda disini!" required><br>

        <label class="form-label" for="alamat">Alamat</label>
        <input class="form-control" type="text" id="alamat" name="alamat" placeholder="Masukkan alamat anda disini!" required><br>
