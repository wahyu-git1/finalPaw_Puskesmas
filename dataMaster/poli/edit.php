...
<?php include "../componen/navigasi.php";?>
    ...
    <form action="" method="post">
        ...
        <input class="form-control" type="text" name="kodepoli" value="<?= $baris['id_poli'] ?>" readonly><br>

        <label for="namapoli">Nama Poliklinik</label>
        <input class="form-control" type="text" name="namapoli" value="<?= $baris['nama_poli'] ?>"><br>

        <label for="gedung">Nama Gedung</label>
        <input class="form-control" type="text" name="gedung" value="<?= $baris['gedung'] ?>"><br>
