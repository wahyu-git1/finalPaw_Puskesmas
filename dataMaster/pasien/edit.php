...
<?php include "../componen/navigasi.php";?>
    ...
    <form action="" method="post">
        ...
        <input class="form-control" type="text" name="kodepasien" value="<?= $baris['id_pasien'] ?>"><br>
        
        <label for="nomoridentitas">Nomor Identitas Pasien</label>
        <input class="form-control" type="text" name="nomoridentitas" value="<?= $baris['nomor_identitas'] ?>"><br>

        <label for="namapasien">Nama Pasien</label>
        <input class="form-control" type="text" name="namapasien" value="<?= $baris['nama_pasien'] ?>"><br>
