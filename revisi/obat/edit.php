...
<?php include "../componen/navigasi.php";?>
    ...
    <form action="" method="post">
        ...
        <input type="text" name="kodeobat" value="<?= $baris['id_obat'] ?>" readonly><br>

        <label for="namaobat">Nama Obat</label>
        <input type="text" name="namaobat" value="<?= $baris['nama_obat'] ?>"><br>

        <label for="keterangan">Keterangan</label>
        <input type="text" name="keterangan" value="<?= $baris['keterangan'] ?>"><br>
