          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark " data-bs-popper="static">
                <li><a class="dropdown-item" href="../dokter/dokter.php">Data Dokter</a></li>
                <li><a class="dropdown-item" href="../obat/obat.php">Data Obat</a></li>
                <li><a class="dropdown-item" href="../pasien/pasien.php">Data Pasien</a></li>
                <li><a class="dropdown-item" href="../poli/poli.php">Data Poli</a></li>
              </ul>
            </li>
            <li class="navbar-nav">
