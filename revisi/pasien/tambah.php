...
<?php include "../componen/navigasi.php";?>
    ...
    <form action="" method="post">
        ...
        <input type="text" id="kodepasien" name="kodepasien" placeholder="Masukkan kode pasien disini!" required><br>
        
        <label for="identitas">Nomor Identitas</label>
        <input type="text" id="identitas" name="identitas" placeholder="Masukkan nomor identitas pasien disini!" required><br>
        
        <label for="namapasien">Nama Pasien</label>
        <input type="text" id="namapasien" name="namapasien" placeholder="Masukkan nama pasien disini!" required><br>
        ...
        <input type="text" id="alamat" name="alamat" placeholder="Masukkan alamat pasien disini!" required><br>
