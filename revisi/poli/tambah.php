...
<?php include "../componen/navigasi.php";?>
    ...
    <form action="" method="post">
        ...
        <input type="text" id="kodepoli" name="kodepoli" placeholder="Masukkan kode poliklinik disini!" required><br>
        
        <label for="namapoli">Nama Poliklinik</label>
        <input type="text" id="namapoli" name="namapoli" placeholder="Masukkan nama poliklinik disini!" required><br>
        
        <label for="gedung">Nama Gedung</label>
        <input type="text" id="gedung" name="gedung" placeholder="Masukkan nama gedung poliklinik disini!" required><br>
