...
<?php include "../componen/navigasi.php";?>
    ...
    <form action="" method="post">
        ...
        <input type="text" name="kodedokter" value="<?= $baris['id_dokter'] ?>" readonly><br>

        <label for="namadokter">Nama Dokter</label>
        <input type="text" name="namadokter" value="<?= $baris['nama_dokter'] ?>"><br>

        <label for="spesialis">Spesialis</label>
        <input type="text" name="spesialis" value="<?= $baris['spesialis'] ?>"><br>
